...
typedef enum
{
    ...
    /** Specifies a BLE device which implements the Wahoo Gym Connect Service */
    WF_SENSORTYPE_WAHOO_GYM_CONNECT              = 0x10000000,
    /** Specifies a BLE device which implements Wahoo Advanced Fitness Machine Service */
    WF_SENSORTYPE_WAHOO_ADVANCED_FITNESS_MACHINE = 0x80000000,
    
    WF_SENSORTYPE_WAHOO_HEADWIND                 = 0x100000000,
    WF_SENSORTYPE_WAHOO_KICKR_BIKE               = 0x200000000,
} WFSensorType_t;

static WFSensorType_t wfSensorTypeFromNSNumber(NSNumber *number)
{
	return (WFSensorType_t)number.longLongValue;
}
...
typedef enum
{
    ...
    WF_SENSOR_SUBTYPE_BIKE_POWER_KICKR_SNAP = 12,
    /** Specifies the Wahoo KICKR CORE Bike Trainer. */
    WF_SENSOR_SUBTYPE_BIKE_POWER_KICKR_CORE = 17,
    ...
    /** Specifies the Wahoo TICKR Optical Heart Rate sensor. */
    WF_SENSOR_SUBTYPE_HEARTRATE_TICKR_FIT = 15,
...
typedef enum
{
    ...
    //** Specifies Public ANT devices */
    WF_NETWORKTYPE_PUBLIC_ANT                        = 0x08,
    
    /** Wildcard for all ANT networks
     */
    WF_NETWORKTYPE_ANT                             = WF_NETWORKTYPE_ANTPLUS | WF_NETWORKTYPE_PUBLIC_ANT,
     ...
     * will be cancelled.
     */
    WF_NETWORKTYPE_ANY                              = WF_NETWORKTYPE_ANTPLUS | WF_NETWORKTYPE_SUUNTO | WF_NETWORKTYPE_BTLE | WF_NETWORKTYPE_PUBLIC_ANT,
...
enum
{
    ...
    /** The command was rejected because the command is not permitted in the devce's curent state */
    WFDeviceControlPointErrorCommandNotPermittedInCurrentState = 10,
    /** The operation could not be performed because the required device is not available at this time */
    WFDeviceControlPointErrorDeviceNotAvailable = 11,
};
...
#ifndef _WF_CP_RESPONSE_ORIGIN_T_
...
#endif //_WF_CP_RESPONSE_ORIGIN_T_
