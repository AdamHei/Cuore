...
#define MIN_ULONG                      ((ULONG) 0)
   ...
   #if !defined(BASETYPES) && !defined(_WinToMac_h_) && !defined(_OBJC_OBJC_H_)  // MMOORE: 2/22/2013 - added exception for Obj-C, which already defines BOOL.
      // typedef signed char              BOOL;                // MMOORE:  changed unsigned to signed to maintain compatibility between apple obj-c and c++.
...
#ifdef DSI_TYPES_MACINTOSH                                  // MMOORE - 2/22/2013 added for 64-bit OSX compatibility
